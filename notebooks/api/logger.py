...
class DetectionLogger:
    ...
    Permet l'audit et le reentrainement futur (§3.5 apprentissage continu).
    """
    ...
    def log_detection(self, result: dict) -> None:
        """Journalise une detection dans le fichier JSONL."""
        entry = {
        ...
        # Mise a jour des statistiques en memoire
        self.stats["total"] += 1
