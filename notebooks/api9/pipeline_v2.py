...
class HybridEmailPipelineV2:
    ...
    def _aggregate(self, rule_spam: float, rule_phish: float,
        ...
        # Seuils calibrés sur le test set réel (27 061 emails)
        # Seuil défaut argmax : F1-Macro = 0.7357 (précision phishing = 40%)
        # Seuils calibrés     : F1-Macro = 0.9018 (precision phishing = 93.9%)
